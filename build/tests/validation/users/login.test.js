...
describe('Tests for validating the login data', function () {
  ...
  it('Should return an error when a user tries to login  with an invalid email',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should return an error when a user tries to login  without a password',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('Should return an error when a user tries to login  with non-existent credentials',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
